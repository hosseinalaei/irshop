...
const Dashboard = () => {
  ...
  return (
    <>
      <div className="grid justify-start w-full grid-cols-1 mb-2 gap-x-2 xl:grid-cols-12 lg:grid-cols-3 sm:grid-cols-2">
        <div className="px-4 pt-4 pb-7 bg-white flex-col gap-1 justify-between  w-full max-h-64 xl:col-span-4 xl:row-start-2 lg:row-start-3 rounded-xl border border-[#E7E7E7]">
          ...
          <div className="flex justify-between h-full max-w-xs sm:flex-col md:flex-row 2xl:max-w-none max-h-60 md:pb-5">
            <div className="self-center sm:mt-2 md:mt-0 md:self-end">
      ...
      <div className="grid justify-start w-full grid-cols-1 xl:grid-cols-12 lg:grid-cols-3 sm:grid-cols-2">
        <div className="p-3 bg-white flex flex-col xl:col-span-12 xl:row-auto lg:row-start-4 lg:col-span-2 rounded-xl border border-[#E7E7E7]">
          ...
          <div className="w-full max-w-xl mt-1 overflow-x-scroll md:overflow-auto xs:max-w-xl sm:max-w-xl md:max-w-7xl 2xl:max-w-none">
            <table className="w-full overflow-scroll text-left border-separate table-auto md:overflow-auto font-inter border-spacing-y-1">
